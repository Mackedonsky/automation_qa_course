...
class ResizablePageLocators:
    ...
    RESIZABLE_BOX_HANDLE = (
        By.CSS_SELECTOR, 'div[id="resizableBoxWithRestriction"] span[class="react-resizable-handle '
...
class DroppablePageLocators:
    ...
    DROP_HERE = (By.CSS_SELECTOR, 'div[id="simpleDropContainer"] [id="droppable"]')
    # or (By.CSS_SELECTOR, #simpleDropContainer #droppable)
    ...
    DROP_HERE_ACCEPT = (By.CSS_SELECTOR, 'div[id="acceptDropContainer"] [id="droppable"]')
    ...
    DROP_HERE_REVERT = (By.CSS_SELECTOR, 'div[id="revertableDropContainer"] [id="droppable"]')
