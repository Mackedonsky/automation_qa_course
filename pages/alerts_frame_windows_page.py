...
class BrowserWindowsPage(BasePage):
    ...
    def check_opened_new_tab(self):
        self.action_new_tab(self.element_is_visible(self.locators.NEW_TAB_BUTTON))
        self.driver.switch_to.window(self.driver.window_handles[1])
        text_title = self.element_is_present(self.locators.TITLE_NEW_TAB).text
        return text_title

    def check_opened_new_window(self):
        self.action_new_tab(self.element_is_visible(self.locators.NEW_WINDOW_BUTTON))
        self.driver.switch_to.window(self.driver.window_handles[1])
        text_title = self.element_is_present(self.locators.TITLE_NEW_TAB).text
        return text_title
...
class FramesPage(BasePage):
    ...
    def check_frame_presence(self, frame_num):
        if frame_num == 'frame1':
...
class ModalDialogsPage(BasePage):
    ...
    def check_modal_dialogs(self):
        ...
        body_small_text = self.element_is_visible(self.locators.SMALL_BODY_MODAL).text
        ...
        body_large_text = self.element_is_visible(self.locators.LARGE_BODY_MODAL).text
